...
**
** Created: Sun Sep 12 18:15:53 2010
...
static const char qt_meta_stringdata_WorkerThread[] = {
    "WorkerThread\0\0error\0error(QString)\0"
    "reply\0handleNetFinished(QNetworkReply*)\0"
};
...
int WorkerThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: handleNetFinished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
